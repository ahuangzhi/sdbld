package com.bld.project.system.menu.service;
...
import com.bld.common.utils.TreeUtils;
import com.bld.common.utils.security.ShiroUtils;
import com.bld.framework.web.domain.Ztree;
import com.bld.project.system.menu.domain.Menu;
import com.bld.project.system.menu.mapper.MenuMapper;
...
public class MenuServiceImpl implements IMenuService
{
    ...
    public List<Menu> selectAll() {
        List<Menu> menus1 = menuMapper.selectMenuNormalAll();
        List<Menu> menus = menuMapper.selectAll();
        return TreeUtils.getChildPerms(menus1,0);
    }
}
