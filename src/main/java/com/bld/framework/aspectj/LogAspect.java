...
import com.bld.framework.aspectj.lang.enums.BusinessStatus;
import com.bld.framework.manager.AsyncManager;
import com.bld.framework.manager.factory.AsyncFactory;
import com.bld.project.monitor.operlog.domain.OperLog;
...
public class LogAspect
{
    ...
    // 配置织入点
    @Pointcut("@annotation(com.bld.framework.aspectj.lang.annotation.Log)")
